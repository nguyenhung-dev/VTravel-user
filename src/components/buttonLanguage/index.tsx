...
export default function ButtonLanguage() {
  const [position, setPosition] = useState<string>("en")
    ...
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-md  px-3 py-2 text-sm font-semibold cursor-pointer">
          {position == "en" ? <Image alt="English" src="/svg/language/en.svg" width={20} height={20} /> : <Image alt="Tiếng Việt" src="/svg/language/vi.svg" width={20} height={20} />}
        </MenuButton>
      </div>
