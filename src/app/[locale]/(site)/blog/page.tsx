    ...
    <div>
      <BannerPage classNameSection={`${styles.banner} h-screen w-full`}>
          ...
          <MotionFade animation="fadeInBottomToTop">
            <h3 className={`${styles.subTitle} font-[700] text-[120px] italic w-[1800px] h-auto mx-auto`}>Blog</h3>
            <h1 className={`${styles.mainTitle} font-[900] text-[180px] leading-[1] w-[1800px] h-auto mx-auto`}>VTRAVEL</h1>
          </MotionFade>
          </div>
